...
const Product = () => {
  ...
  return productData ? (
    <>
      <SEO
        title={`${productData.name} | Buy Online – Smart Grocery`}
        description={`Buy ${productData.name} online with fast delivery and fresh quality guarantee.`}
        keywords={`${productData.name}, buy groceries online, fresh food delivery`}
        url={`https://forever-main-f.vercel.app/product/${productData._id}`}
