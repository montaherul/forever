...
const About = () => {
  return (
    <>
      <SEO
        title="About Smart Grocery | Fresh & Organic Grocery Delivery"
        description="Learn about Smart Grocery and our mission to deliver fresh, organic groceries from local farms."
        keywords="about smart grocery, organic grocery delivery"
        url="https://forever-main-f.vercel.app/about"
          ...
          <div className="flex flex-col justify-center gap-6 md:w-1/2 text-gray-600">
            <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl border-l-4 border-green-600 dark:border-green-500">
              ...
              <p className="leading-relaxed dark:text-slate-300">
                Smart Grocery was born out of a passion for fresh, healthy
                living and a desire to revolutionize the way people shop for
                groceries online. Our journey began with a simple idea: to
                connect local farms directly to your doorstep, ensuring maximum
            ...
            <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-xl border-l-4 border-orange-600 dark:border-orange-500">
              ...
              <p className="leading-relaxed dark:text-slate-300">
                ...
                carefully selected for quality, freshness, and nutritional
                value.
              </p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl border-l-4 border-blue-600 dark:border-blue-500">
              ...
              <p className="leading-relaxed dark:text-slate-300">
                100% fresh guarantee, same-day delivery, and complete
                transparency about where your food comes from. Your health and
