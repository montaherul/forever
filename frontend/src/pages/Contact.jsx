...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Smart Grocery | Customer Support"
        description="Contact Smart Grocery for help, support, or business inquiries. We’re always happy to help."
        keywords="contact grocery store, grocery customer support"
        url="https://forever-main-f.vercel.app/contact"
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="p-6 sm:p-8 rounded-2xl shadow-md border bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 dark:border-blue-700">
              ...
              <div className="text-gray-700 dark:text-slate-300 text-sm sm:text-base space-y-1">
                <p>
                  <span className="font-semibold">Mon – Fri:</span> 8:00 AM –
                  8:00 PM
                </p>
                <p>
