...
const Profile = () => {
  const { backendUrl, token, user, setUser, navigate, authChecked } =
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 mb-12">
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 text-sm">
              Save your delivery information for quick and easy checkout on all
              future orders
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 text-sm">
              Keep track of all your orders and manage multiple delivery
              addresses
            </p>
          </div>
        </div>
