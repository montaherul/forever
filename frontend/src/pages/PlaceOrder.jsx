...
const PlaceOrder = () => {
  ...
  return (
    <>
      <SEO
        title="Secure Checkout | Smart Grocery"
        description="Secure checkout with multiple payment options and fast grocery delivery."
        keywords="secure checkout, grocery payment"
        url="https://forever-main-f.vercel.app/place-order"
