...
const Collection = () => {
  ...
  return (
    <>
      <SEO
        title="Shop Fresh Groceries Online | Smart Grocery"
        description="Shop fresh and organic groceries online. Best prices, fast delivery, and farm-fresh quality."
        keywords="shop groceries online, organic grocery store, fresh food delivery"
        url="https://forever-main-f.vercel.app/collection"
