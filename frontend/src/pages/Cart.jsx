...
const Cart = () => {
  ...
  return (
    <>
      <SEO
        title="Your Cart | Smart Grocery"
        description="Review your cart and proceed to secure checkout for fresh grocery delivery."
        keywords="grocery cart, online grocery checkout"
        url="https://forever-main-f.vercel.app/cart"
